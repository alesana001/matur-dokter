...
public class DetailInfoKesehatanActivity extends AppCompatActivity {
...
//    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detail_info_kesehatan);
        Intent a = getIntent();
    ...
    class TampilDetailBerita extends AsyncTask<String,String,String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            progressDialog = new ProgressDialog(DetailInfoKesehatanActivity.this);
        ...
        protected String doInBackground(String... params) {
            try {
                ...
                JSONObject jsonObject = jsonParser.makeHttpRequest(config.url_detail_berita,"GET",parampa);
